"""dlelas_25174 URL Configuration
...
admin.site.site_header = "Dlelas"
admin.site.site_title = "Dlelas Admin Portal"
admin.site.index_title = "Dlelas Admin"

# swagger
api_info = openapi.Info(
    title="Dlelas API",
    default_version="v1",
    description="API documentation for Dlelas App",
)
